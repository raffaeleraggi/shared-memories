...
public record MediaDto(UUID id, String originalFilename, String publicUrl, String contentType, Long size, boolean approved, LocalDateTime uploadedAt, String uploadedBy, String message) {
